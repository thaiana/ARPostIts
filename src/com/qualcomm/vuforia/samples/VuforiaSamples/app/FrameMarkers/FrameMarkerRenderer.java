...
public class FrameMarkerRenderer implements GLSurfaceView.Renderer 
{
	...
	HashMap<Integer, String[]> tarefas;
...
/*			//lista de itens para cada marcador
			String[] lista0 = {"marker 0", "Colocar por id do marcador", "construir integração", "tarefa 3", "tarefa 4"};
			String[] lista1 = {"marker 0", "Colocar por id do marcador", "construir integração", "tarefa 3", "tarefa 4"};
			String[] lista2 = {"marker 0", "Colocar por id do marcador", "construir integração", "tarefa 3", "tarefa 4"};
			String[] lista3 = {"marker 0", "Colocar por id do marcador", "construir integração", "tarefa 3", "tarefa 4"};
			
			tarefas.put(0, lista0);
			tarefas.put(1, lista1);
			tarefas.put(2, lista2);
			tarefas.put(3, lista3);*/
	...
	public void displayList(){
		View view = mActivity.findViewById(android.R.id.list);
		//String[] lista0 = {"Colocar por id do marcador", "construir integração", "tarefa 3", "tarefa 4"}; 
		//tarefas.put(0, lista0);
		
	    ArrayAdapter<String> adapter = new ArrayAdapter<String>(
	    		mActivity.getApplicationContext(), android.R.layout.simple_list_item_1, android.R.id.text1);	
	    adapter.addAll(tarefas.get(markerId));
